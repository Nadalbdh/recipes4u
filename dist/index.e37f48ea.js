...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        // close form window
        setTimeout(()=>{
            _addRecipeViewJsDefault.default.toggleWindowAndOverlay();
...
const init = function() {
    ...
    _recipeViewJsDefault.default.addHandlerAddBookmark(controlToggleBookmark);
...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","regenerator-runtime/runtime":"dXNgZ","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultView.js":"f70O5","./views/bookmarkView.js":"7YaI3","./views/paginationView.js":"6z7bi","./views/addRecipeView.js":"i6DNj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
const KEY = 'f7005994-4290-46b3-9069-6f6751d8b53f';
const MODAL_CLOSE_SEC = 0.5; // '74cad1e7-bea6-4309-b2f7-961c36658d73'
...
class RecipeView extends _viewJsDefault.default {
    ...
    _generateIngredients(ing) {
      ...
      <div class="recipe__quantity">${_fractyDefault.default(ing.quantity ?? '')}</div>
...
},{"url:../../img/icons.svg":"loVOp","fracty":"hJO4d","./view.js":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"loVOp":[function(require,module,exports) {
...
class ResultView extends _viewJsDefault.default {
    ...
    _generateMarkUp() {
        ...
        return this._data.map((el)=>_previewViewJsDefault.default.render(el, false)
        ).join('');
    }
}
...
},{"./view.js":"bWlJ9","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7YaI3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./view.js":"bWlJ9","url:../../img/icons.svg":"loVOp","./previewView.js":"1FDQ6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6z7bi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"url:../../img/icons.svg":"loVOp","fracty":"hJO4d","./view.js":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class AddRecipeView extends _viewJsDefault.default {
    ...
    _generateMarkUp() {
        // this._data points to bookmarks array
        return this._data.map((el)=>previewView.render(el, false)
        ).join('');
    }
}
exports.default = new AddRecipeView();

},{"./view.js":"bWlJ9","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ddCAb","aenu9"], "aenu9", "parcelRequire6d3a")
